...
class TicTacToeBoard(_TTTB, Node):
    ...
    def reward(board):
        # print('reward: winner', board.winner, 'turn', board.turn)
        if not board.terminal:
            raise RuntimeError(f"reward called on nonterminal board {board}")
        if board.winner is board.turn:  # after a move is made 'turn' attribute flips, but if winner will be assigned it would be previous action taker.
